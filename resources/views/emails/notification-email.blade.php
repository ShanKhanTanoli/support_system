                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="#" align="center"
                                            style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; text-decoration:none; font-weight:700;letter-spacing: 3px; line-height: 35px;">
                                            Customer Support
                                        </a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <p style="line-height: 24px; margin-bottom:15px;">
                                            Dear, {!! Str::ucfirst($data['customer_name']) !!}
                                        </p>
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            Your Ticket for {!! strtoupper($data['support_type']) !!} has been {!! $data['status'] !!} .
                                            <br />
                                        </p>
                                        <p style="line-height: 24px;margin-bottom:15px;">
